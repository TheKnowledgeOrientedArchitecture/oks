...
def forwards_func(apps, schema_editor):
    ...
    new_org.save()
    new_org_ks = KnowledgeServer(name="A demo OKS used as a client.", scheme="http", netloc="client.beta.thekoa.org", description="", organization=new_org, this_ks=True, html_home="", html_disclaimer="")
    new_org_ks.save()
