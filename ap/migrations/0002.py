...
from knowledge_server.models import KnowledgeServer, DataSet, DataSetStructure
...
def forwards_func(apps, schema_editor):
    ...
    mm_workflow = dss_workflow.create_model_metadata(name="Workflow",module="ap",name_field="name",description_field="description")
    mm_workflow_status = dss_workflow.create_model_metadata(name="WorkflowStatus",module="ap",name_field="name",description_field="description")
    ...
    KnowledgeServer.register_models([mm_workflow, mm_workflow_status, mm_workflow_method, mm_attribute_in_a_method, mm_permission_statement, mm_attribute, mm_widget, mm_permission_holder])
