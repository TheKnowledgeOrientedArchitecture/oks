...
from geo.models import Continent, SubContinent, State, Region, Province
from knowledge_server.utils import KsUrl

def forwards_func(apps, schema_editor):
    org_ks={
      "Organization": {"name": "A test Organization for geo data", "website": "http://new_org.example.com", "description": ""}, 
    ...
    mmContinent=dssContinentState.create_model_metadata(name="Continent",module="geo",name_field="name",description_field="")
    mmSubContinent=dssContinentState.create_model_metadata(name="SubContinent",module="geo",name_field="name",description_field="")
    mmState=dssContinentState.create_model_metadata(name="State",module="geo",name_field="name",description_field="")
